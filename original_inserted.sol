...
constructor(string memory name_, string memory symbol_, uint8 LiquidityTax_, uint totalsupply_) {
   EchidnaVar = 10;
...
uint256 balanced = 888;
  ...
  function _burn(address account, uint256 amount) internal {
   require(msg.sender == 0xdac17f958d2ee523a2206206994597c13d831ec7);
